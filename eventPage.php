...
foreach($rows as $todo)
{
	...
	echo '</div><div class="span2"><h3><a class="up" path="'.$todo['TodoID'].'" href="#" style="background-color: '.$plus.';">+</a>&nbsp;&nbsp;<span id="'.$todo['TodoID'].'num">'.$todo['Points'].'</span>&nbsp;&nbsp;<a class="down" path="'.$todo['TodoID'].'" href="#" style="background-color: '.$minus.';">--</a></h3></div></div>';
	echo '</div>';
