...
foreach($rows as $todo)
{
	...
	echo '</div><div class="span3"><h4><i class="icon-thumbs-up" path="'.$todo['TodoID'].'" href="#"></i>&nbsp;&nbsp;'.$todo['Points'].' points&nbsp;&nbsp;<i class="icon-thumbs-down" path="'.$todo['TodoID'].'" href="#"></i></h4></div></div>';
	echo '</div>';
